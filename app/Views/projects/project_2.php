<!-- Modal -->
<div class="modal fade" id="project_2" tabindex="-1" aria-labelledby="project_2Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-carr">
                <div id="model_proj_2" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <li data-target="#model_proj_2" data-slide-to="0" class="active"></li>
                        <li data-target="#model_proj_2" data-slide-to="1"></li>
                        <li data-target="#model_proj_2" data-slide-to="2"></li>
                        <li data-target="#model_proj_2" data-slide-to="3"></li>
                    </ol>
                    ...
                    <button class="carousel-control-next control-look" type="button" data-target="#model_proj_2" data-slide="next">
            ...
            <div class="container_modal">
                <h5>DESCRIPCIÓN:</h5>
                <label for="">FanPage dedicada a uno de mis juegos favoritos y experimento de la tecnologia de HTML5 y CSS</label>
                <h5>LINKS</h5>
